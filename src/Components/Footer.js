...
function Footer() {
    return (
        <footer className="page-footer font-small unique-color-dark mt-5">
            ...
            <div style={{background: 'linear-gradient(90deg, #1e293b 0%, #0f172a 100%)', borderTop: '1px solid rgba(255,255,255,0.1)'}}>
                <div className="container">
                    <div className="row py-4 d-flex justify-content-center align-items-center">
                        <div className="col-md-6 col-lg-5 text-center footer-text text-white">
                            Check out our <a href="   " className='footer-link' style={{color: '#00d2ff'}}>Github repo</a> for more information!
                        </div>
                    </div>
                </div>
            </div>

            <div className='container-fluid text-white pt-3' style={{backgroundColor:'#0f172a'}}>
                <div className="container text-md-left mt-5">
                    <div className="row mt-3">
                        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            <h6 className="text-uppercase font-weight-bold">SILENT TALK</h6>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p><a href="https://github.com/spectre900/Audio-to-Sign-Language-using-3D-Avatars" className='footer-link'>  </a></p>
                        </div>

                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            <h6 className="text-uppercase font-weight-bold">Contact</h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width:'60px'}}/>
                            <p><i className="fa fa-lg fa-home me-3 ms-0"></i><span className='footer-text'> </span></p>
                            <p><i className="fa fa-envelope me-3 ms-0"></i><span className='footer-text'>  </span> </p>
                            <p><i className="fa fa-envelope me-3 ms-0"></i><span className='footer-text'>  </span> </p>
                            <p><i className="fa fa-phone me-3 ms-0"></i><span className='footer-text'>  </span> </p>
                            <p><i className="fa fa-phone me-3 ms-0"></i><span className='footer-text'>  </span> </p>
                        </div>
                    </div>
                </div>
